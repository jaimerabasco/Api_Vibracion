...
function repetir_vibracion(){
	...
	//repetir = setInterval(function(){alert("hola");},1500);
}
...
if(window.navigator && window.navigator.vibrate){
	...
	//document.querySelector("#vibrar_rep").addEventListener("click", setInterval(function(){navigator.vibrate([1000,750,1000,750]);},3500),false);
	...
	//document.querySelector("#vibrar_apagar").addEventListener("click", function(){navigator.vibrate(0);},false);
